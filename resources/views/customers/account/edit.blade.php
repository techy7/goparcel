              ...
              <div class="col-md-12">
                ...
                {{-- <div class="form-group form-group-default required @error('email') has-error @enderror">
                  ...
                  <div class="form-group form-group-default required @error('m_number') has-error @enderror">
                    ...
                    <input type="text" pattern="[0-9]*" inputmode="numeric" maxlength="15" id="m_number" name="m_number" value="{{ old('m_number', $user->m_number) }}" placeholder="{{ __('account.enter_field', ['field' => strtolower(__('account.mobile_number'))]) }}" class="form-control" required>
                  </div>
                  @error('m_number')
                ...
                @enderror
                  ...
                  <div class="form-group form-group-default required @error('postal_code') has-error @enderror">
                    ...
                    <input type="text" pattern="[0-9]*" inputmode="numeric" maxlength="4" id="postal_code" name="postal_code" value="{{ old('postal_code', $user->postal_code) }}" placeholder="{{ __('account.enter_field', ['field' => strtolower(__('account.postal_code'))]) }}" class="form-control" required>
                  </div>
                  @error('postal_code')
