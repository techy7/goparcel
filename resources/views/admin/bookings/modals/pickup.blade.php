<div class="modal fade slide-up disable-scroll" id="modalSlideUp-{{ $pickup->id }}-{{ $pickup->id }}-{{ $pickup->id }}-{{ $pickup->id }}" tabindex="-1" role="dialog" aria-labelledby="modalSlideUpLabel" aria-hidden="false">
      ...
      <div class="modal-content-wrapper">
        <div class="modal-content">
          <div class="modal-header clearfix text-left">
            ...
            <p class="p-b-10">Here's the pickup detail of {{ $pickup->user->name }}.</p>
          </div>
              ...
              <div class="form-group-attached">
                <div class="row">
                  <div class="col-md-12 m-l-20">
                      ...
                      <p class="bold font-montserrat text-uppercase">Delivery Status: <span><small class="text-uppercase">{{ $pickup->pickupActivities->first()->deliveryStatus->name }}</small></span></p>
