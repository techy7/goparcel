            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-group-default required @error('m_number') has-error @enderror">
                        ...
                        <input type="text" pattern="[0-9]*" inputmode="numeric" id="m_number" name="m_number" placeholder="{{ __('auth.enter_field', ['field' => strtolower(__('auth.mobile_number'))]) }}" value="{{ old('m_number') ?? $userData->m_number }}" class="form-control" >
                    </div>
                    @error('m_number')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group form-group-default @error('postal_code') has-error @enderror">
                        ...
                        <input type="text" pattern="[0-9]*" inputmode="numeric" id="postal_code" name="postal_code" placeholder="{{ __('auth.enter_field', ['field' => strtolower(__('auth.postal_code'))]) }}" value="{{ old('postal_code') ?? $userData->postal_code }}" class="form-control" >
                    </div>
                    @error('postal_code')
