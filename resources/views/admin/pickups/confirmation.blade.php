...
@section('title', 'Delete Customer Pickup')
    ...
    <div class="container-fluid padding-25 sm-padding-10">
        <div class="container-fixed-lg">
            <ul class="breadcrumb p-l-0">
              ...
              <li class="breadcrumb-item active">Delete Customer Pickup</li>
            </ul>
            <h3 class="page-title">Delete Customer Pickup Confirmation</h3>
        </div>

        <form id="form-register" class="p-t-15" role="form" method="POST" action="{{ route('admin.pickups.destroy', $pickup->id) }}">
            @csrf
            @method('DELETE')
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="btn-group btn-group-md">
                        ...
                        <button class="btn btn-primary btn-lg btn-cons m-t-10" type="submit">Delete Customer Pickup</button>
                    </div>
                </div>
            </div>
        </form>
