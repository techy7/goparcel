...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8" />
    <title>GoParcel Admin Dashboard</title>
  ...
  <body class="fixed-header dashboard">
      ...
      <div class="sidebar-overlay-slide from-top" id="appMenu">
        <div class="row">
          <div class="col-xs-6 no-padding">
            <a href="#" class="p-l-40"><img src="{{ asset('pages/assets/img/demo/social_app.svg') }}" alt="socail">
            </a>
          </div>
          <div class="col-xs-6 no-padding">
            <a href="#" class="p-l-10"><img src="{{ asset('pages/assets/img/demo/email_app.svg') }}" alt="socail">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-6 m-t-20 no-padding">
            <a href="#" class="p-l-40"><img src="{{ asset('pages/assets/img/demo/calendar_app.svg') }}" alt="socail">
            </a>
          </div>
          <div class="col-xs-6 m-t-20 no-padding">
            <a href="#" class="p-l-10"><img src="{{ asset('pages/assets/img/demo/add_more.svg') }}" alt="socail">
            </a>
          </div>
        </div>
      </div>
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            <img width="30" height="30" data-src-retina="{{ asset('pages/assets/img/profiles/1x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/1.jpg') }}" alt="" src="{{ asset('pages/assets/img/profiles/1.jpg') }}">
                          </div>
                      ...
                      <div class="widget-1 card  bg-complete no-margin widget-loader-circle-lg">
                        ...
                        <div class="card-body">
                          <div class="pull-bottom bottom-left bottom-right ">
                            <span class="label font-montserrat fs-11 all-caps">explore</span>
                            <br>
                    ...
                    <div class="ar-2-1">
                      ...
                      <div class="widget-4 card   no-margin widget-loader-bar">
                        <div class="container-sm-height full-height d-flex flex-column">
						  ...
						  <span class="font-montserrat fs-11 all-caps">Product revenue </span>
                ...
                <div class="row">
                  <div class="col-sm-6 m-b-10">
                    <div class="ar-1-1">
                      ...
                      <div class="widget-2 card  bg-primary widget widget-loader-circle-lg no-margin">
                        <div class="card-header ">
                          <div class="card-controls">
                            <ul>
                        ...
                        <div class="card-body">
                          <div class="pull-bottom bottom-left bottom-right padding-25">
                            ...
                            <p class="text-white hint-text d-none d-lg-block d-xl-block d-none d-lg-block d-xl-block no-margin">Learn More at Project Pages</p>
                          </div>
                        </div>
                      </div>
                      <!-- END WIDGET -->
                  ...
                  <div class="col-sm-6 m-b-10">
                    <div class="ar-1-1">
                      ...
                      <div class="widget-3 card  bg-complete no-margin widget-loader-bar">
                          ...
                          <div class="metro live-tile" data-mode="carousel" data-start-now="true" data-delay="3000">
                                ...
                                <div class="pull-top">
                                  ...
                                  <div class="pull-right">
                                    <ul class="list-inline ">
                                      <li>
                                        <a href="#" class="no-decoration"><i class="pg-icon">comment_alt</i>
                                        </a>
                                      </li>
                                      <li>
                                        <a href="#" class="widget-3-fav no-decoration"><i class="pg-icon">heart_outline</i>
                                        </a>
                                      </li>
                                    </ul>
                                  </div>
                            ...
                            <div class="slide-back tiles">
                              <div class="padding-25">
                                ...
                                <div class="pull-bottom p-b-30">
                                  <p class="p-t-10 fs-12 p-b-5 hint-text">21 Jan</p>
                                  <h3 class="no-margin">A whole new
                                <br>
                ...
                <div class="row">
                  <div class="col-sm-6 m-b-10">
                    <div class="ar-1-1">
                      ...
                      <div class="card bg-contrast-medium widget widget-6 widget-loader-circle-lg no-margin">
                        <div class="card-header ">
                          <div class="card-controls">
                            <ul>
                        ...
                        <div class="card-body">
                          <div class="pull-bottom bottom-left bottom-right padding-25">
                            <h1 class="semi-bold">30&#176;</h1>
                            <span class="label font-montserrat fs-11">TODAY</span>
                            <p class="m-t-20">Feels like rainy</p>
                            <p class="hint-text m-t-30 no-margin">January 2020, 5 Thusday </p>
                          </div>
                        </div>
                      </div>
                      <!-- END WIDGET -->
                  ...
                  <div class="col-sm-6 m-b-10">
                    <div class="ar-1-1">
                      ...
                      <div class="widget-7 card  bg-success no-margin">
                        <div class="card-body no-padding full-height">
                  ...
                  <div class="padding-15">
                    <div class="item-header clearfix">
                      <div class="thumbnail-wrapper d32 circular">
                        <img width="40" height="40" src="{{ asset('pages/assets/img/profiles/3x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/3.jpg') }}" data-src-retina="{{ asset('pages/assets/img/profiles/3x.jpg') }}" alt="">
                      </div>
                    ...
                    <div class="card   no-margin">
                      ...
                      <div class="relative">
                        ...
                        <div class="widget-19-post no-overflow">
                          <img src="{{ asset('pages/assets/img/social-post-image.png') }}" class="block center-margin relative" alt="Post">
                        </div>
                      </div>
                      <div class="padding-15">
                        <div class="hint-text pull-left fs-13">few seconds ago</div>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/1x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/1.jpg') }}" src="{{ asset('pages/assets/img/profiles/1x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/2x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/2.jpg') }}" src="{{ asset('pages/assets/img/profiles/2x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/3x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/3.jpg') }}" src="{{ asset('pages/assets/img/profiles/3x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/4x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/4.jpg') }}" src="{{ asset('pages/assets/img/profiles/4x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/5x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/5.jpg') }}" src="{{ asset('pages/assets/img/profiles/5x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/6x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/6.jpg') }}" src="{{ asset('pages/assets/img/profiles/6x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/7x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/7.jpg') }}" src="{{ asset('pages/assets/img/profiles/7x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/8x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/8.jpg') }}" src="{{ asset('pages/assets/img/profiles/8x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ asset('pages/assets/img/profiles/9x.jpg') }}" data-src="{{ asset('pages/assets/img/profiles/9.jpg') }}" src="{{ asset('pages/assets/img/profiles/9x.jpg') }}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="{{ asset('pages/assets/img/profiles/avatar_small.jpg') }}" alt="" data-src="{{ asset('pages/assets/img/profiles/avatar_small.jpg') }}" data-src-retina="{{ asset('pages/assets/img/profiles/avatar_small2x.jpg') }}">
                  </div>
    ...
    <script src="{{ asset('pages/assets/plugins/mapplic/js/hammer.min.js') }}"></script>
    <script src="{{ asset('pages/assets/plugins/mapplic/js/jquery.mousewheel.js') }}"></script>
    <script src="{{ asset('pages/assets/plugins/mapplic/js/mapplic.js') }}"></script>
    <script src="{{ asset('pages/assets/plugins/rickshaw/rickshaw.min.js') }}"></script>
    <script src="{{ asset('pages/assets/plugins/jquery-metrojs/MetroJs.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('pages/assets/plugins/jquery-sparkline/jquery.sparkline.min.js') }}" type="text/javascript"></script>
